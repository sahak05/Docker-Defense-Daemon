  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="break-words">{alert.type}</DialogTitle>
        ...
        <div className="space-y-4 overflow-y-auto max-h-[60vh]">
          ...
          <div className="min-w-0">
            ...
            <p
              className="text-foreground break-words overflow-wrap-anywhere whitespace-pre-wrap w-full"
              style={{
          ...
          <div className="min-w-0">
            ...
            <p className="text-foreground break-words w-full overflow-wrap">
              {alert.details}
            </p>
          </div>
          ...
          {alert.suggestedAction && (
            ...
            >
              ...
              <p
                className="text-sm text-foreground break-words w-full"
